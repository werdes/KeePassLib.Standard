...
namespace KeePassLib.Security
{
	...
	public sealed class ProtectedBinary : IEquatable<ProtectedBinary>
	{
		...
		private void Encrypt()
		{
			...
			{
#if NETCOREAPP
                byte[] protectedData = CryptoUtil.ProtectData(m_pbData, null, DataProtectionScope.CurrentUser);
		...
		private void Decrypt()
		{
            ...
            {
#if NETCOREAPP
                byte[] unprotectedData = CryptoUtil.UnprotectData(m_pbData, null, DataProtectionScope.CurrentUser);
				Array.Clear(m_pbData, 0, m_pbData.Length);
